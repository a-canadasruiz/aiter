...
GPU 6 / gfx950 / `FLYDSL_RUNTIME_ENABLE_CACHE=0`. Set equality `err=0`. Times
are **not** a win claim (serial LDS select on lane 0):
...
oracle tie-break on vLLM MQA logits, same as phase 1.
