...
declare -a tune_jobs=(
  ...
  "fhmoe:csrc/ck_gemm_moe_2stages_codegen:op_tests/test_fhmoe.py:python3 csrc/ck_gemm_moe_2stages_codegen/gemm_moe_tune.py --fhmoe -i aiter/configs/untuned_fhmoe.csv -o aiter/configs/tuned_fhmoe.csv"
